...
class Hybrid_v3_baseline(IStrategy):
    """
    Hybrid_v3 — Paper-Validated Dual-Mode Regime-Adaptive Architecture
...
# Alias class so --strategy "Hybrid_v3" also works (2026-06-07 OOS baseline fix).
# freqtrade resolves strategies by class __name__, so a module-level variable
# alias is insufficient — must be a real class with __name__ == "Hybrid_v3".
