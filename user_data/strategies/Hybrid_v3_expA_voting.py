#!/usr/bin/env python3
"""
Hybrid_v3_expA_voting — expA: 進場投票 (≥2/9) on top of Hybrid_v3 base
# expA: 進場投票 - 至少 2 個 BB_RPB 條件同時成立才進場
...
class Hybrid_v3_expA_voting(IStrategy):
    """
    Hybrid_v3 — Paper-Validated Dual-Mode Regime-Adaptive Architecture
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # expA: Voting — at least 2 of 9 conditions must agree
        _cond_list = [
            is_BB_checked,
            is_local_uptrend,
            is_local_dip,
        ...
        _vote_count = sum(_cond_list)  # count of True per row
        bb_rpb_conditions = _vote_count >= 2
