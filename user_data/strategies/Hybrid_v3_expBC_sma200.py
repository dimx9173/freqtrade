#!/usr/bin/env python3
"""
Hybrid_v3_expBC_sma200 — expBC_sma200: 3-way 組合 (B strict ADX + C_sma200 volatility) on top of Hybrid_v3 base
# expBC_sma200: 嚴格 ADX 15/28 + ATR(14) > SMA(ATR, 200) — 三贏家組合
# 從 BC_combo (sma100) 升級到 sma200, 預期更少 trades, 更高 WR
...
class Hybrid_v3_expBC_sma200(IStrategy):
    """
    Hybrid_v3 — Paper-Validated Dual-Mode Regime-Adaptive Architecture
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # expBC_sma200: Volatility expansion filter — only enter when ATR is above its 200-bar mean
        dataframe["_atr_14_bcs200"] = ta.ATR(dataframe, timeperiod=14)
        dataframe["_atr_ma_200_bcs200"] = dataframe["_atr_14_bcs200"].rolling(200).mean()
        dataframe["_vol_expanding_bcs200"] = (
            dataframe["_atr_14_bcs200"] > dataframe["_atr_ma_200_bcs200"]
        ).astype(int)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        ranging_entry = (
            ...
            & (dataframe["_vol_expanding_bcs200"] == 1)  # expBC_sma200 gate
        )
