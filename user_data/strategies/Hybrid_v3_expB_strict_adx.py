#!/usr/bin/env python3
"""
Hybrid_v3_expB_strict_adx — expB: 嚴格 ADX regime (15/28) on top of Hybrid_v3 base
# expB: 嚴格 ADX regime - 15/28 取代 20/22, 只讓最強的趨勢被認成 trending
...
class Hybrid_v3_expB_strict_adx(IStrategy):
    """
    Hybrid_v3 — Paper-Validated Dual-Mode Regime-Adaptive Architecture
    ...
    # expB: Strict ADX — only strongest trends count as trending
    ADX_RANGING_MAX: float = 15.0  # expB: was 20.0
    # P1: Lower threshold so more regimes are classified as trending
    ADX_TRENDING_MIN: float = 28.0  # expB: was 22.0 (must be > 15 to avoid empty band)
    # 20–22 = transition
