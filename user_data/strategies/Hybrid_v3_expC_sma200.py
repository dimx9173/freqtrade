#!/usr/bin/env python3
"""
Hybrid_v3_expC_sma200 — expC_sma200: 波動率擴張過濾 (SMA window=200) on top of Hybrid_v3 base
# expC_sma200: ATR(14) > SMA(ATR(14), 200) — 反應更慢, 預期更少 trades
...
class Hybrid_v3_expC_sma200(IStrategy):
    """
    Hybrid_v3 — Paper-Validated Dual-Mode Regime-Adaptive Architecture
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # expC_sma200: Volatility expansion filter — only enter when ATR is above its 200-bar mean
        dataframe["_atr_14_c200"] = ta.ATR(dataframe, timeperiod=14)
        dataframe["_atr_ma_200_c200"] = dataframe["_atr_14_c200"].rolling(200).mean()
        dataframe["_vol_expanding_c200"] = (
            dataframe["_atr_14_c200"] > dataframe["_atr_ma_200_c200"]
        ).astype(int)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        ranging_entry = (
            ...
            & (dataframe["_vol_expanding_c200"] == 1)  # expC_sma200 gate
        )
