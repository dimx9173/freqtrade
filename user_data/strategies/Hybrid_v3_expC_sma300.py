#!/usr/bin/env python3
"""
Hybrid_v3_expC_sma300 — expC_sma300: 波動率擴張過濾 (SMA window=300) on top of Hybrid_v3 base
# expC_sma300: ATR(14) > SMA(ATR(14), 300) — 最長 window, 預期最少 trades 最高品質
...
class Hybrid_v3_expC_sma300(IStrategy):
    """
    Hybrid_v3 — Paper-Validated Dual-Mode Regime-Adaptive Architecture
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # expC_sma300: Volatility expansion filter — only enter when ATR is above its 300-bar mean
        dataframe["_atr_14_c300"] = ta.ATR(dataframe, timeperiod=14)
        dataframe["_atr_ma_300_c300"] = dataframe["_atr_14_c300"].rolling(300).mean()
        dataframe["_vol_expanding_c300"] = (
            dataframe["_atr_14_c300"] > dataframe["_atr_ma_300_c300"]
        ).astype(int)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        ranging_entry = (
            ...
            & (dataframe["_vol_expanding_c300"] == 1)  # expC_sma300 gate
        )
