#!/usr/bin/env python3
"""
Hybrid_v3_expC_sma50 — expC_sma50: 波動率擴張過濾 (SMA window=50) on top of Hybrid_v3 base
# expC_sma50: ATR(14) > SMA(ATR(14), 50) — 反應更快, 預期更多 trades
...
class Hybrid_v3_expC_sma50(IStrategy):
    """
    Hybrid_v3 — Paper-Validated Dual-Mode Regime-Adaptive Architecture
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["_atr_14_c50"] = ta.ATR(dataframe, timeperiod=14)
        dataframe["_atr_ma_50_c50"] = dataframe["_atr_14_c50"].rolling(50).mean()
        dataframe["_vol_expanding_c50"] = (
            dataframe["_atr_14_c50"] > dataframe["_atr_ma_50_c50"]
        ).astype(int)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        ranging_entry = (
            ...
            & (dataframe["_vol_expanding_c50"] == 1)  # expC_sma50 gate
        )
