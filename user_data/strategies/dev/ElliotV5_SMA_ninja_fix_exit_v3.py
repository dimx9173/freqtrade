...
sell_params = {"base_nb_candles_sell": 49, "high_offset": 1.05}
...
class ElliotV5_SMA_ninja_fix_exit_v3(IStrategy):
    INTERFACE_VERSION = 2

    # B_trail: 收緊 trailing，快速落袋
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Original exit: price above MA sell with RSI filter
        conditions.append(
            (
                (
                    dataframe["close"]
        ...
        # v3: tight_exit_cross — RSI high reversal exit
        conditions.append(
            (
                (dataframe["rsi"] > 70)
