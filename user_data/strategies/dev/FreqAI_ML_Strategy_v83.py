...
"""
FreqAI ML Strategy V83 — Regression (raw return %)
Pairs: BTC/USDT only
Timeframe: 5m
...
CHANGE from V82:
- Timeframe: 5m instead of 15m (prediction horizon stays 12 bars = 1 hour ahead)
- Same prediction horizon in real time, faster iteration for intraday trading
"""
...
class FreqAI_ML_Strategy_v83(IStrategy):
    """
