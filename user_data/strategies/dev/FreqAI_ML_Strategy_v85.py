...
"""
FreqAI ML Strategy V85 — Regression (raw return %)
Pairs: BTC/USDT only
Timeframe: 5m
...
CHANGE from V83:
- Stop loss: -2.5% (tightened from -5% to prevent large drawdowns)
- ROI: +3% (lowered from +10% to take profits earlier and improve win rate)
- Trailing stop adjusted accordingly
"""
...
class FreqAI_ML_Strategy_v85(IStrategy):
    """
