...
"""
FreqAI ML Strategy V92 — Wide R:R Scalp (1:3)
...
class FreqAI_ML_Strategy_v92(IStrategy):
    """
    ...
    # ===========================================
    minimal_roi = {
        "0": 0.03,  # 3% take profit (3R)
        "60": 0.02,  # 2% after 1h
        "180": 0.01,  # 1% after 3h (time exit)
    }
    ...
    def populate_entry_trend(self, dataframe: pd.DataFrame, metadata: dict) -> pd.DataFrame:
        ...
        long_cond = (ml_pred > 0.002) & (rsi < 75)
        short_cond = (ml_pred < -0.002) & (rsi > 25)
