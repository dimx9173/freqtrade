"""
VCB_MACD_1h_TP6_SL1.0 - VCB + MACD with Balanced TP/SL
========================================================
TOP VARIANT #2: TP=6%, SL=1.0% (R:R = 6:1)
...
class VCB_MACD_1h_TP6_SL1_0(IStrategy):
    """
    VCB - Volatility Compression Breakout (TP6/SL1.0 variant)
    低波動壓縮後的方向突破進場 + MACD 零軸上方過濾
    均衡 TP/SL: 6%/1.0% (R:R = 6:1)
    """
