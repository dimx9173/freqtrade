# NASOSv5_mod3 V52 - WIDER_TRAILING Configuration
# Mission: Wider trailing stop (0.01 start, 0.005 offset) to let winners run longer
# Based on: NASOSv5_mod3
...
class NASOSv5_mod3_V52(IStrategy):
    """
    🚀 WIDER_TRAILING Strategy V52 - Let Winners Run Longer 🚀

    Key Change from V51:
    - trailing_stop_positive: 0.001 → 0.01 (10x wider trigger, 1% profit needed to activate trailing)
    - trailing_stop_positive_offset: 0.03 → 0.005 (6x tighter offset, 0.5% below peak)

    Rationale: Original 0.1% trigger was too tight, causing premature exits.
    New 1% trigger allows more upside before trailing activates.
    Tighter 0.5% offset still provides protection but lets winners run.
    """
    ...
    # Trailing stop - V52 WIDER CONFIGURATION
    trailing_stop = True  # value loaded from strategy
    trailing_stop_positive = 0.01  # V52: 1% profit to trigger (was 0.001)
    trailing_stop_positive_offset = 0.02  # V52: 2% offset from peak (was 0.03)
