...
class PSV5_Hybrid(IStrategy):
    ...
    minimal_roi = {
        "0": 0.06,  # 6% initial target
        "180": 0.04,  # 4% after 180 min
        "360": 0.02,  # 2% after 360 min
    }
    trailing_stop = True
    ...
    roi_roi_0 = DecimalParameter(0.03, 0.10, default=0.06, decimals=2, space="roi")
    roi_roi_180 = DecimalParameter(0.02, 0.06, default=0.04, decimals=2, space="roi")
    roi_roi_360 = DecimalParameter(0.01, 0.04, default=0.02, decimals=2, space="roi")
