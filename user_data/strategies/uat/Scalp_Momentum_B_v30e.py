"""
Scalp_Momentum_B_v30e - Trailing Stop Adjustment
===============================================
Based on v28: Change trailing_stop_positive 0.002→0.003, trailing_stop_positive_offset 0.004→0.005
Other parameters kept identical to v28.
"""
...
class Scalp_Momentum_B_v30e(IStrategy):
    # Fixed parameters
    stoploss = -0.02
    minimal_roi = {
        "1": 0.004,
    ...
    # Trailing stop (CHANGED from v28: 0.002/0.004 → 0.003/0.005)
    trailing_stop = True
